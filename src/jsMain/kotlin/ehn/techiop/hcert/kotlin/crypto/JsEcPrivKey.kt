...
class JsEcPrivKey(val dValue: Buffer, val ec: EC, private val keySizeBits: Int) : JsPrivKey {

    constructor(keyPair: EcKeyPair, keySizeBits: Int) : this(
        keyPair.getPrivate().toArrayLike(Buffer),
        keyPair.ec,
        keySizeBits
    )

    override fun toCoseRepresentation() = object : EcCosePrivateKey {
