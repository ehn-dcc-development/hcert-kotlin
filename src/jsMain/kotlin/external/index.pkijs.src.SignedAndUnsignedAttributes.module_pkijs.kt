@file:JsModule("pkijs/src/SignedAndUnsignedAttributes")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.SignedAndUnsignedAttributes
...
@JsName("default")
external open class SignedAndUnsignedAttributes(params: Any = definedExternally) {
    open var type: String
    open var attributes: Array<Attribute>
    open var encodedValue: ArrayBuffer
