@file:JsModule("pkijs/src/SignerInfo")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.SignerInfo
...
@JsName("default")
external open class SignerInfo(params: Any = definedExternally) {
    open var version: Number
    open var sid: Any
    open var digestAlgorithm: Any
    open var signedAttrs: Any
    open var unsignedAttrs: Any
    open var signatureAlgorithm: Any
    open var signature: OctetString
