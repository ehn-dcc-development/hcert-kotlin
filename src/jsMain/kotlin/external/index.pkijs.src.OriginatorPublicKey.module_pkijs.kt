@file:JsModule("pkijs/src/OriginatorPublicKey")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.OriginatorPublicKey
...
@JsName("default")
external open class OriginatorPublicKey(params: Any = definedExternally) {
    open var algorithm: Any
    open var publicKey: BitString
