@file:JsModule("pkijs/src/PKIStatusInfo")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.PKIStatusInfo
...
import org.w3c.xhr.*
import Asn1js.Utf8String
import Asn1js.BitString

@JsName("default")
external open class PKIStatusInfo(params: Any = definedExternally) {
    open var status: Number
    open var statusStrings: Utf8String
    open var failInfo: BitString
