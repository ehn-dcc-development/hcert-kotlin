@file:JsModule("pkijs/src/Request")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.Request
...
@JsName("default")
external open class Request(params: Any = definedExternally) {
    open var reqCert: Any
    open var singleRequestExtensions: Array<Extension>
