...
open external class edwards(conf: EdwardsConf) : base {
    ...
    open fun point(
        x: String,
        y: Any /* String | BN | Number | Buffer | Uint8Array | ReadonlyArray<Number> */,
        z: Any /* String | BN | Number | Buffer | Uint8Array | ReadonlyArray<Number> */ = definedExternally,
        t: Any /* String | BN | Number | Buffer | Uint8Array | ReadonlyArray<Number> */ = definedExternally
    ): EdwardsPoint
...
open external class short(conf: ShortConf) : base {
    ...
    open fun point(
        x: String,
        y: Any /* String | BN | Number | Buffer | Uint8Array | ReadonlyArray<Number> */,
        isRed: Boolean = definedExternally
    ): ShortPoint
    ...
    open fun pointFromJSON(
        obj: Array<Any /* String | BN | Number | Buffer | Uint8Array | ReadonlyArray<Number> */>,
        red: Boolean
    ): ShortPoint
