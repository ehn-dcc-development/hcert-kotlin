@file:JsModule("pkijs/src/EncapsulatedContentInfo")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.EncapsulatedContentInfo
...
@JsName("default")
external open class EncapsulatedContentInfo(params: Any = definedExternally) {
    open var eContentType: String
    open var eContent: OctetString
