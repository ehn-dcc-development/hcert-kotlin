@file:JsModule("pkijs/src/ResponseBytes")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.ResponseBytes
...
@JsName("default")
external open class ResponseBytes(params: Any = definedExternally) {
    open var responseType: String
    open var response: OctetString
