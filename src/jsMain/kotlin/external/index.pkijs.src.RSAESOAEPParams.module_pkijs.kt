@file:JsModule("pkijs/src/RSAESOAEPParams")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.RSAESOAEPParams
...
@JsName("default")
external open class RSAESOAEPParams(params: Any = definedExternally) {
    open var hashAlgorithm: Any
    open var maskGenAlgorithm: Any
    open var pSourceAlgorithm: Any
