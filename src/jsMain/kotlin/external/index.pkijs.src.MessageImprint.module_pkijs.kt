@file:JsModule("pkijs/src/MessageImprint")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.MessageImprint
...
@JsName("default")
external open class MessageImprint(params: Any = definedExternally) {
    open var hashAlgorithm: Any
    open var hashedMessage: OctetString
