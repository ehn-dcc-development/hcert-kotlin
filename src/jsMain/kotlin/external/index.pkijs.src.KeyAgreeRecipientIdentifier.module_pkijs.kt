@file:JsModule("pkijs/src/KeyAgreeRecipientIdentifier")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.KeyAgreeRecipientIdentifier
...
@JsName("default")
external open class KeyAgreeRecipientIdentifier(params: Any = definedExternally) {
    open var variant: Number
    open var value: Any
