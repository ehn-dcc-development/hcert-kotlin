@file:JsModule("pkijs/src/OriginatorIdentifierOrKey")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.OriginatorIdentifierOrKey
...
@JsName("default")
external open class OriginatorIdentifierOrKey(params: Any = definedExternally) {
