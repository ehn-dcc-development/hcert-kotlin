@file:JsModule("pkijs/src/TimeStampReq")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.TimeStampReq
...
@JsName("default")
external open class TimeStampReq(params: Any = definedExternally) {
    open var version: Number
    open var messageImprint: Any
    open var reqPolicy: String
    open var nonce: Integer
    open var certReq: Boolean
