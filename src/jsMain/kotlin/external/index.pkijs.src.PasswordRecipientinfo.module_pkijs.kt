@file:JsModule("pkijs/src/PasswordRecipientinfo")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.PasswordRecipientinfo
...
@JsName("default")
external open class PasswordRecipientinfo(params: Any = definedExternally) {
    open var version: Number
    open var keyDerivationAlgorithm: Any
    open var keyEncryptionAlgorithm: Any
    open var encryptedKey: OctetString
    open var password: ArrayBuffer
