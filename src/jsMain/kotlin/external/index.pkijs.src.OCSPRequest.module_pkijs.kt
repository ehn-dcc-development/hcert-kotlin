@file:JsModule("pkijs/src/OCSPRequest")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.OCSPRequest
...
@JsName("default")
external open class OCSPRequest(params: Any = definedExternally) {
    open var tbsRequest: Any
    open var optionalSignature: Any
