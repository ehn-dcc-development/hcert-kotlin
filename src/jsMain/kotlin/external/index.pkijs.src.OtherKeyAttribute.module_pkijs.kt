@file:JsModule("pkijs/src/OtherKeyAttribute")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.OtherKeyAttribute
...
@JsName("default")
external open class OtherKeyAttribute(params: Any = definedExternally) {
    open var keyAttrId: String
    open var keyAttr: Any
