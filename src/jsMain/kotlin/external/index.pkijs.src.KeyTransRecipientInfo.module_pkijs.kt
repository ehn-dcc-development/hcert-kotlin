@file:JsModule("pkijs/src/KeyTransRecipientInfo")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.KeyTransRecipientInfo
...
@JsName("default")
external open class KeyTransRecipientInfo(params: Any = definedExternally) {
