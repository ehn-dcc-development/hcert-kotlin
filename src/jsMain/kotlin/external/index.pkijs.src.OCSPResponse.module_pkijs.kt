@file:JsModule("pkijs/src/OCSPResponse")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.OCSPResponse
...
import org.w3c.xhr.*
import Asn1js.Enumerated
import tsstdlib.PromiseLike
import pkijs.src.BasicOCSPResponse.GetCertificateStatusResult
import pkijs.src.CertID.CreateFroCertificateParams
import pkijs.src.Certificate.Certificate

@JsName("default")
external open class OCSPResponse(params: Any = definedExternally) {
    open var responseStatus: Enumerated
    open var responseBytes: Any
