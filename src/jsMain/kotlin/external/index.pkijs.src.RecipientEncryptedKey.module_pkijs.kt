@file:JsModule("pkijs/src/RecipientEncryptedKey")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.RecipientEncryptedKey
...
@JsName("default")
external open class RecipientEncryptedKey(params: Any = definedExternally) {
    open var rid: Any
