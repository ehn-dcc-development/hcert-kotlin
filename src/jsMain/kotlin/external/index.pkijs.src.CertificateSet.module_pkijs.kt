@file:JsModule("pkijs/src/CertificateSet")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.CertificateSet
...
@JsName("default")
external open class CertificateSet(params: Any = definedExternally) {
    open var certificates: Array<Certificate>
