@file:JsModule("pkijs/src/SubjectDirectoryAttributes")
@file:JsNonModule
@file:Suppress("INTERFACE_WITH_SUPERCLASS", "OVERRIDING_FINAL_MEMBER", "RETURN_TYPE_MISMATCH_ON_OVERRIDE", "CONFLICTING_OVERLOADS")
package pkijs.src.SubjectDirectoryAttributes
...
@JsName("default")
external open class SubjectDirectoryAttributes(params: Any = definedExternally) {
